        ...
        for example_dict in examples_list_of_dicts:
            ...
            for max_mot in [2,5,10]:
                for random_motion_seed_ind in ['seed1', 'seed2']: 
                    ...
                    # For inter-shot
                    args.experiment_name_L1min = f"_{args.L1min_mode}_rottrans{max_mot}_Ns{args.Ns}_motEvents{num_motion_events}_motSeed{random_motion_seed}"
                    # For intra-shot
                    #args.experiment_name_L1min = f"_{args.L1min_mode}_rottrans{max_mot}_Ns{args.Ns}_motEvents{num_motion_events}_intraEvents{args.num_intraShot_events}_motSeed{random_motion_seed}"
