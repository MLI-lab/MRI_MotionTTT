...
if __name__ == '__main__':
    ...
    with open(args.valset_data_path,'rb') as fn:
                    ...
                    for example_dict in examples_list_of_dicts[0:1]:
                        ...
                        for max_mot in [5]:
                            for random_motion_seed_ind in ['seed1']:
                                ...
                                args.altopt_nufft_max_coil_size = 12
                                ...
                                args.experiment_name_TTT= f"_rottrans{max_mot}_Ns{Ns}_Nshots{TTT_num_shots}_motEvents{num_motion_events}_intraEvents{args.num_intraShot_events}_motSeed{random_motion_seed}_splits{args.TTT_states_per_split}"
