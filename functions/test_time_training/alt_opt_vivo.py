...
class AltOptModuleVivo(AltOptModuleBase):
    ...
    def load_data_init_motion(self):
        ...
        masked_corrupted_kspace3D, masked_motion_free_kspace3D, mask3D, smaps3D_conj, traj, binary_background_mask, smaps3D = invivo_loader(self.args, self.args.altopt_results_path)
