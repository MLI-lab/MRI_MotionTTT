                    ...
                    for num_motion_events in [10,5,1]:
                        for example_dict in examples_list_of_dicts:
                            ...
                            for random_motion_seed_ind in ['seed1','seed2']:
                                ...
                                args.experiment_run_folder_name = "test_interShot_interlTraj_fixFirstState_initlr4.0_3phase_splits1_initSplitMotAvg_run54/"
                                ...
                                args.TTT_sampTraj_simMot = "interleaved_cartesian"
